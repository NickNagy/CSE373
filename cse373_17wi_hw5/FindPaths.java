...
public class FindPaths {
	public static void main(String[] args) {
		...
		while(true) {
			...
			// prints out the shortest path between a and b and its cost if a
			// path from a to b exists, otherwise prints "does not exist"
			if(shortest!=null){
				System.out.println(Arrays.toString(shortest.vertices.toArray()));
